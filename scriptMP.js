...
const slideTextMasks = {
  ...
  8: [
    {
      left: 452 / 1280 * 100, top: 184 / 720 * 100, width: 645 / 1280 * 100, height: 394 / 720 * 100,
      className: 'slide-text-mask',
      html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 645 394" width="100%" height="100%" style="display:block">
...
async function submitSurveyToGoogleForm() {
  ...
  try {
    await fetch(
      "https://docs.google.com/forms/d/e/1FAIpQLSdZJHEcZM-KLNTe8SYf5HHeYOeLCbWNuWJ2QaovyHNrRpHnrA/formResponse",
      {
        method: "POST",
        mode: "no-cors",
        body: formData
